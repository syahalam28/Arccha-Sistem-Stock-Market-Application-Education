        ...
        <div class="row">
            <div class="col">
                <div class="title text-center">
                    ...
                    <p>Informasi Berita Pasar Saham dan Strategi Finansial</p>
                </div>
            </div>
        </div>
        <div class="row">
            <?php if ((in_groups('operator')) | (in_groups('admin'))) : ?>
                <div class="col-sm-12 mb-5">
                    <a href="<?= base_url('Berita/index'); ?>" class="btn btn-success">Tambah Berita</a>
                ...
                <div class="col-sm-4 ">
                    <div class="card mb-3" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('berita/' . $b['info_id']); ?>" class="btn btn-dark">Baca Selengkapnya</a>
