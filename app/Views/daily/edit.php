        ...
        <div class="container mt-3 w-100">
            ...
            <div class="card shadow-sm w-100">
                ...
                <div class="col-sm-12 mt-3  ">
                    ...
                    <form class="form" action="<?= base_url('berita/update/' . $berita->info_id); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12 ">
                    ...
                    <small><a href="<?= base_url('utama/berita'); ?>">&laquo; Back TO News List</a>
                    </small>
                </div>
