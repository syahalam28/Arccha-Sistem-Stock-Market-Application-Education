        ...
        <div class="container mt-3 w-100">
            ...
            <div class="card shadow-sm w-100 mb-5">
                ...
                <div class="col-sm-12 mt-3  ">
                    ...
                    <form class="form" action="/Berita/saveInfo" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12 mt-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="https://drive.google.com/file/d/16iqnBuym0HiUvb5eDRxcy6ZYvFRHww9_/preview" aria-label="Username" aria-describedby="basic-addon1" name="link" value="">
                    </div>
